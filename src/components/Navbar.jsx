...
const Navbar = () => {
  ...
  const handleMunuBtnClick = () => {
    const nav = document.querySelector(".nav-svg");
    const navToggleSvg = document.querySelector(".nav-toggle");
    nav.classList.toggle("open");
    navToggleSvg.classList.toggle;
    setOpen(!open);
  };
  return (
    <header className="fixed top-0 w-full py-4 z-20">
      <div
        id="container"
        className="mr-auto ml-auto pl-[2rem] xl:pl-[3.5rem] xl:pr-[4rem] pr-[2rem] max-w-[144rem]"
      >
        <div className="grid grid-cols-12 gap-x-10 items-center">
          <div id="logo" className="col-span-6">
            <a href="http://localhost:5173/" className="inline-flex">
              <svg
                className="text-xl"
                width="79" // Increased width
          ...
          >
            <div
              className="w-24 h-24 flex items-center justify-center nav-svg"
